...
public class HammerView extends LinearLayout {
    ...
    public HammerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public HammerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_hammer_view_layout, this,true);
        ...
        if(spPool==null){
            ...
            music = spPool.load(mContext, R.raw.hammer_audio, 1);
...
//            id_student_reward_text.setText("恭喜“"+username+"”获得一个大大的奖励！");
            id_student_reward_text.setText(username+"要加油哦~");
        }else{
            id_student_reward_text.setText("你要加油哦~");
